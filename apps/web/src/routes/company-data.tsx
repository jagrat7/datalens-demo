...
function CompanyDataComponent() {
  ...
  return (
    <div>
      ...
      >
        <Button size="sm" onClick={() => toast.info("Upload is not wired up in this v0 demo")}>
                ...
                <TableRow key={document.id}>
                  ...
                  <TableCell className="text-right">
                    <Button
                      ...
                      onClick={() =>
                        toast.info("Downloads are not wired up in this v0 demo")
                      }
                    >
              ...
              {filtered.length === 0 ? (
                <TableRow>
                  <TableCell colSpan={7} className="h-24 text-center text-muted-foreground">
                    No documents match “{query}”. Try a different search or category.
                  </TableCell>
                </TableRow>
              ) : null}
            </TableBody>
